...
futureEnv <- raster::getData(name = 'CMIP5', var = 'bio', res = 2.5,
                             rcp = 20, model = 'IP', year = 50, path="data") 
...
ggsave(filename="optimisticFutureSDM50years.jpg", plot=last_plot(),path="output", width=1600, height=800, units="px")
